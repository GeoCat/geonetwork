...
export const APIS = [AtomService, AuditableService, CustomstyleService, DoiserversService, EealayoutupdateService, FormattersService, GroupsService, HarvestersService, IdentifiersService, LanguagesService, LinksService, LogosService, MapserversService, MapservicesService, MeService, OaipmhService, OperationsService, PagesService, ProcessesService, RecordsService, RegionsService, RegistriesService, RelatedService, SearchService, SelectionsService, SiteService, SourcesService, StandardsService, StatusService, TagsService, ToolsService, TranslationprovidersService, UiService, UserfeedbackService, UsersService, UsersearchesService, UserselectionsService];
