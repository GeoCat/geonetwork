...
export class PagesService extends BaseService {
  ...
  public addPageUploadingFile(
    ...
    sections?: Array<
      ...
      | 'CUSTOM_MENU3'
    >,
    status?: 'PUBLIC' | 'PUBLIC_ONLY' | 'GROUPS' | 'PRIVATE' | 'HIDDEN',
  ...
  public addPageUploadingFile(
    ...
    localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>pageId, 'pageId');
    if (sections) {
    ...
    if (data !== undefined) {
      localVarFormParams =
        (localVarFormParams.append('data', <any>data) as any) || localVarFormParams;
    }
  ...
  ): Observable<HttpResponse<PageProperties>>;
  public getPage(
    language: string,
    pageId: string,
    observe?: 'events',
  ...
  ): Observable<HttpEvent<PageProperties>>;
  public getPage(
    language: string,
    pageId: string,
    observe: any = 'body',
