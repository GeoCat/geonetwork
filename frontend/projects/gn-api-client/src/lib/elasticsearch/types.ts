...
export interface MsearchMultiSearchResult<
  TDocument = unknown,
...
export type MsearchResponse<
  TDocument = unknown,
  TAggregations = Record<AggregateName, AggregationsAggregate>,
> = MsearchMultiSearchResult<TDocument, TAggregations>;
export type MsearchResponseItem<TDocument = unknown> =
  | MsearchMultiSearchItem<TDocument>
  | ErrorResponseBase;
...
export type MsearchTemplateResponse<
  TDocument = unknown,
  TAggregations = Record<AggregateName, AggregationsAggregate>,
> = MsearchMultiSearchResult<TDocument, TAggregations>;
...
export interface SearchCompletionSuggester extends SearchSuggesterBase {
  contexts?: Record<
    Field,
    SearchCompletionContext | SearchContext | (SearchCompletionContext | SearchContext)[]
  >;
...
export type SearchSuggest<TDocument = unknown> =
...
export type AggregationsCalendarInterval =
  | 'second'
  | '1s'
  | 'minute'
  | '1m'
...
export type AggregationsCardinalityExecutionMode =
  | 'global_ordinals'
  | 'segment_ordinals'
  | 'direct'
...
export type AggregationsMovingAverageAggregation =
...
export type AggregationsPercentiles =
...
export type AggregationsVariableWidthHistogramBucket =
...
export type AnalysisCharFilterDefinition =
...
export type AnalysisIcuCollationStrength =
  | 'primary'
  | 'secondary'
  | 'tertiary'
  | 'quaternary'
...
export type AnalysisPhoneticEncoder =
  | 'metaphone'
  | 'double_metaphone'
  | 'soundex'
  | 'refined_soundex'
  ...
  | 'beider_morse'
  | 'daitch_mokotoff';
export type AnalysisPhoneticLanguage =
  | 'any'
  | 'common'
  | 'cyrillic'
  | 'english'
...
export type AnalysisTokenFilterDefinition =
...
export interface AsyncSearchAsyncSearch<
  TDocument = unknown,
  TAggregations = Record<AggregateName, AggregationsAggregate>,
> {
  aggregations?: TAggregations;
...
export interface AsyncSearchAsyncSearchDocumentResponseBase<
  TDocument = unknown,
  TAggregations = Record<AggregateName, AggregationsAggregate>,
...
export type AsyncSearchGetResponse<
  TDocument = unknown,
  TAggregations = Record<AggregateName, AggregationsAggregate>,
...
export type AsyncSearchSubmitResponse<
  TDocument = unknown,
  TAggregations = Record<AggregateName, AggregationsAggregate>,
> = AsyncSearchAsyncSearchDocumentResponseBase<TDocument, TAggregations>;
...
export type CatCatAnomalyDetectorColumn =
  ...
  | 'state'
  | 's';
export type CatCatAnonalyDetectorColumns =
  | CatCatAnomalyDetectorColumn
  | CatCatAnomalyDetectorColumn[];
export type CatCatDatafeedColumn =
  | 'ae'
  | 'assignment_explanation'
  | 'bc'
  | 'buckets.count'
...
export type CatCatTransformColumn =
...
export type ClusterRemoteInfoClusterRemoteInfo =
...
export type ConnectorConnectorStatus =
  | 'created'
  | 'needs_configuration'
  | 'configured'
  | 'connected'
...
export type ConnectorFilteringRuleRule =
  | 'contains'
  | 'ends_with'
  | 'equals'
  | 'regex'
...
export type EsqlQueryEsqlFormat =
  | 'csv'
  | 'json'
  | 'tsv'
  | 'txt'
...
export type IlmExplainLifecycleLifecycleExplain =
...
export type IndicesSettingsSimilarity =
...
export type IndicesResolveClusterResponse = Record<
  ClusterAlias,
  IndicesResolveClusterResolveClusterInfo
>;
...
export type IndicesShardStoresShardStore = IndicesShardStoresShardStoreKeys & {
  [property: string]:
    | IndicesShardStoresShardStoreNode
...
export type IngestSimulateDocumentSimulation = IngestSimulateDocumentSimulationKeys & {
  [property: string]:
    ...
    | Id
    | IndexName
    | IngestSimulateIngest
    | Record<string, any>
    | SpecUtilsStringified<VersionNumber>
    | VersionType;
};
...
export type MigrationGetFeatureUpgradeStatusMigrationStatus =
  | 'NO_MIGRATION_NEEDED'
  | 'MIGRATION_NEEDED'
  | 'IN_PROGRESS'
  | 'ERROR';
...
export type MlSnapshotUpgradeState =
  | 'loading_old_state'
  | 'saving_new_state'
  | 'stopped'
  | 'failed';
...
export type NodesClearRepositoriesMeteringArchiveResponse =
...
export type QueryRulesQueryRuleCriteriaType =
  | 'global'
  | 'exact'
  | 'exact_fuzzy'
  | 'fuzzy'
...
export type RollupGetJobsIndexingJobState =
  | 'started'
  | 'indexing'
  | 'stopping'
  | 'stopped'
...
export type RollupGetRollupIndexCapsResponse = Record<
  IndexName,
  RollupGetRollupIndexCapsIndexCapabilities
>;
...
export interface RollupRollupSearchResponse<
  TDocument = unknown,
  TAggregations = Record<AggregateName, AggregationsAggregate>,
> {
  took: long;
...
export type SearchApplicationGetBehavioralAnalyticsResponse = Record<
  Name,
...
export type SearchApplicationPutBehavioralAnalyticsResponse =
...
export type SearchApplicationSearchResponse<
  TDocument = unknown,
  TAggregations = Record<AggregateName, AggregationsAggregate>,
> = SearchResponseBody<TDocument, TAggregations>;
...
export type SecurityClusterPrivilege =
  | 'all'
  | 'cancel_task'
  | 'create_snapshot'
...
export type SecurityIndicesPrivilegesQuery =
  | string
...
export type SecurityDeletePrivilegesResponse = Record<
  string,
  Record<string, SecurityDeletePrivilegesFoundStatus>
>;
...
export type SecurityGetPrivilegesResponse = Record<
  string,
  Record<string, SecurityPutPrivilegesActions>
>;
...
export type SecurityGetServiceAccountsResponse = Record<
  string,
...
export interface SecurityGrantApiKeyGrantApiKey {
  ...
  role_descriptors?:
    | Record<string, SecurityRoleDescriptor>
    | Record<string, SecurityRoleDescriptor>[];
  metadata?: Metadata;
}
...
export type SecurityHasPrivilegesApplicationsPrivileges = Record<
  Name,
...
export type SecurityQueryApiKeysApiKeyAggregate =
  | AggregationsCardinalityAggregate
  | AggregationsValueCountAggregate
  | AggregationsStringTermsAggregate
  | AggregationsLongTermsAggregate
...
export type SnapshotSnapshotSort =
  | 'start_time'
  | 'duration'
  | 'name'
  | 'index_count'
...
export type WatcherActionExecutionMode =
  | 'simulate'
  | 'force_simulate'
  | 'execute'
  | 'force_execute'
...
export type WatcherExecutionPhase =
  | 'awaits_execution'
  | 'started'
  | 'input'
  | 'condition'
...
export type WatcherExecutionStatus =
  | 'awaits_execution'
  | 'checking'
